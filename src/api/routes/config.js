  ...
  router.get('/schema/fields', (req, res) => {
    res.json({
      fields: [
        ...
        { key: 'adminOnlyMessage', type: 'string', label: 'Pesan Admin Only' },
        { key: 'groupOnlyMessage', type: 'string', label: 'Pesan Group Only' },
        { key: 'privateOnlyMessage', type: 'string', label: 'Pesan Private Chat Only' },
        { key: 'premiumOnlyMessage', type: 'string', label: 'Pesan Premium Only' },
        { key: 'limitMessage', type: 'string', label: 'Pesan Limit Habis' },
        { key: 'maintenanceMode', type: 'boolean', label: 'Mode Maintenance' },
        { key: 'maintenanceMessage', type: 'string', label: 'Pesan Maintenance' },
        { key: 'useLimit', type: 'boolean', label: 'Gunakan Sistem Limit' },
        { key: 'limitCost', type: 'number', label: 'Limit Terpakai per Perintah' },
        { key: 'defaultLimit', type: 'number', label: 'Limit Default User Baru' },
        {
          key: 'premiumUnlimited',
          type: 'boolean',
          label: 'Premium Unlimited (nonaktifkan untuk dibatasi)',
        },
        {
          key: 'premiumDefaultLimit',
          type: 'number',
          label: 'Limit Default Premium (jika tidak unlimited)',
        },

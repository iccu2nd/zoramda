...
export function createServer(sessionManager) {
  ...
  // Behind Railway/other reverse proxies, this makes req.protocol and
  // req.get('host') reflect the real public domain (X-Forwarded-*) instead
  // of the internal http://localhost the proxy connects to.
  ...
  app.get('/verify-email', (req, res) => res.sendFile(join(publicDir, 'verify-email.html')))
